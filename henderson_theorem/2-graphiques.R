...
p=0
poids_non_equiv <- readRDS(sprintf("henderson_theorem/data/poids_non_equiv_h%i.RDS",6))
...
poids_non_equiv <- readRDS(sprintf("henderson_theorem/data/poids_non_equiv_h%i.RDS",11))
exist_non_equiv <- sapply(poids_non_equiv, function(x){
    sapply(x, nrow)>0
}) 
