...
```{r exgainPhase, echo=FALSE, out.width="100%", fig.cap="Smoothing of the time series $X_t=\\sin(\\omega t)$ by the moving average $M_{\\theta_0}X_t=\\frac{1}{2}X_{t-1}+\\frac{1}{2}X_{t}$ for $\\omega=\\pi/2$.", eval=!is_latex}
