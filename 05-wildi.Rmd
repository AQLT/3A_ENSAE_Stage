...
Les quatres critères $A_w$, $T_w$, $S_w$ et $R_w$ étant des cas particuliers du critère $J$ défini dans l'équation \@ref(eq:theoriegen1), cette méthode s'inscrit dans le cadre de la théorie générale définie dans la section \@(subsec:theoriegen).
En effet, en notant :
$$
\begin{cases}
