...
En effet, dans le cas contraire on néglige l'effet des points atypiques sur l'estimation de la tendance-cycle, ce qui pourrait conduire à des estimations biaisées et à une détection de faux points de retournement.
...
Cependant, la moins bonne performance apparente de l'approche FST et dla méthode basée sur les RKHS semblent de provenir de l'utilisation de filtres sous-optimaux lorsque que l'on s'approche du cas d'utilisation du filtre symétrique.
