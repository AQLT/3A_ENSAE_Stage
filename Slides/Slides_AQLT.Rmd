...
\faArrowCircleRight{} X-11 : décomposition itérative de $X_T$ en $TC_t$, $S_t$ et $I_t$ avec une correction automatique des points atypiques
...
2. Désaisonnalisation en **fixant** la série linéarisée et tous les autres paramètres avec X-11 et un filtre spécifique pour la tendance-cycle (`rjdfilters::x11()`)
...
Rapport : https://aqlt-stage3a.netlify.app/
