\newpage
# Equiv FST {#an:equivfstlp}

 et avec $q=3$ ($S_g(\theta) = \sum_{j}(\nabla^{3}\theta_{j})^{2}$)
...
```{r thhendersonh6, fig.cap = "Ensemble des poids pour lesquels la méthode FST n'est pas équivalente aux moindres carrés pondérés pour $h=6$ (filtre symétrique de 12 termes), sous contrainte de préservation des polynômes de degré au plus 2 ($d=0,1,2$).",fig.height=height_cube}
