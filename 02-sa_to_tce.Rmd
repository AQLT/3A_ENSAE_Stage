...
Des diagrammes synthétiques des liens entre les différentes méthodes étudiés sont présentés dans l'annexe \@ref(an:diag).
...
L'ensemble des filtres utilisés dans résumés dans l'annexe \@ref(an:graphs).
